...
#Used for temp monitoring of SHT85 sensor number 2, uses data on pin 23  and clock on pin 24 (GPIO)
...
sht3x = Sht3xI2cDevice(I2cConnection(LinuxI2cTransceiver('/dev/i2c-4')))
