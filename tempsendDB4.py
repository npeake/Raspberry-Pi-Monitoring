...
#Used for temp monitoring of SHT85 sensor number 4, uses data on pin 20 and clock on pin 21 (GPIO)
...
sht3x = Sht3xI2cDevice(I2cConnection(LinuxI2cTransceiver('/dev/i2c-6')))
