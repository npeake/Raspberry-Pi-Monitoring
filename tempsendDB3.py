...
#Used for temp monitoring of SHT85 sensor number 3, uses data on pin 12  and clock on pin 16 (GPIO)
...
sht3x = Sht3xI2cDevice(I2cConnection(LinuxI2cTransceiver('/dev/i2c-5')))
