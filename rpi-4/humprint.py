#file to print humidity onto LCD screen
import time
import board
import digitalio
...
#start humidity loop and hopefully print to LCD
lcd.message = '     Hello\n     World!'
time.sleep(3.0)
lcd.clear()
...
#can uncomment last two lines to print temperature and humidity to the command line
#DHT sensor can only read every 1.5 seconds, any faster will cause misreads and errors
